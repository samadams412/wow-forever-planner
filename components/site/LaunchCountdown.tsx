...
export default function LaunchCountdown() {
  ...
  return (
    // Same .fx-featured shimmer ring + ambient glow as the homepage's
    // "Start planning" button (no .fx-featured-hover here -- this box isn't
    // clickable, so it only ever shows that ambient half), so the two most
    // important homepage elements read as one visual language rather than
    // two different one-off treatments. Replaces the plain border-accent/50
    // + shadow-gold-glow this used to carry on its own.
    <div className="fx-featured w-full rounded-xl">
      <div className="rounded-xl bg-background/50 px-4 py-4 backdrop-blur-sm sm:px-6">
